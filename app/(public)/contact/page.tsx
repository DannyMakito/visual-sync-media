...
export default function Contact() {
    ...
    return (
        <main className="min-h-screen bg-white">
            {/* Hero Section */}
            <section className="border-b-4 border-black relative overflow-hidden text-white">
                ...
                <div className="relative z-10 py-20 px-4 md:px-8">
                    <div className="max-w-7xl mx-auto">
                        <span className="text-[#ff1a1a] font-bold uppercase tracking-widest text-sm">Get in Touch</span>
            ...
            {/* Contact Form & Info */}
            <section className="py-20 px-4 md:px-8 border-b-4 border-black relative overflow-hidden">
                <div className="absolute inset-0 z-0">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input
                                        ...
                                        required
                                        className="w-full border-4 border-black p-4 font-body focus:border-[#ff1a1a] focus:outline-none transition-colors"
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    onChange={handleChange}
                                    className="w-full border-4 border-black p-4 font-body focus:border-[#ff1a1a] focus:outline-none transition-colors bg-white"
                                >
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    required
                                    rows={6}
                                    className="w-full border-4 border-black p-4 font-body focus:border-[#ff1a1a] focus:outline-none transition-colors resize-none"
                            ...
                            <button
                                type="submit"
                                className="w-full p-4 font-bold uppercase tracking-widest flex items-center justify-center gap-3 transition-colors bg-black text-white hover:bg-[#ff1a1a]"
                            >
                    ...
                    <div className="space-y-12">
                            ...
                            <div className="space-y-6">
                                <a href="mailto:Contact.visualsyncmedia@gmail.com" className="flex items-center gap-4 group">
                                    ...
                                    <div>
                                        ...
                                        <span className="font-display text-xl group-hover:text-[#ff1a1a] transition-colors">Contact.visualsyncmedia@gmail.com</span>
                                    </div>
                                </a>
                        ...
                        <div>
                            ...
                            <div className="flex gap-4">
                                <a href="https://www.facebook.com/share/1SkXM5T2EV/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="w-14 h-14 border-4 border-black flex items-center justify-center hover:bg-black hover:text-white transition-colors">
                                    <Facebook size={24} />
                                </a>
                                <a href="https://www.instagram.com/visualsyncmedia?igsh=aGJ5NWlnbDV4angx" target="_blank" rel="noopener noreferrer" className="w-14 h-14 border-4 border-black flex items-center justify-center hover:bg-black hover:text-white transition-colors">
                                    <Instagram size={24} />
                                </a>
                                <a href="https://x.com/visualsyncsa" target="_blank" rel="noopener noreferrer" className="w-14 h-14 border-4 border-black flex items-center justify-center hover:bg-black hover:text-white transition-colors">
                                    <Twitter size={24} />
                                </a>
                                <a href="https://www.linkedin.com/company/visualsyncmedia/" target="_blank" rel="noopener noreferrer" className="w-14 h-14 border-4 border-black flex items-center justify-center hover:bg-black hover:text-white transition-colors">
                                    <Linkedin size={24} />
                                </a>
                            </div>
                        </div>
            ...
            {/* Map/Location Banner */}
            <section className="bg-gray-100 py-16 px-4 md:px-8 border-b-4 border-black">
                <div className="max-w-7xl mx-auto text-center">
                    <h2 className="font-display text-4xl md:text-5xl uppercase mb-4">
                        Serving Clients <span className="text-[#ff1a1a]">Worldwide</span>
                    </h2>
