...
export default function About() {
    return (
        <main className="min-h-screen bg-white">
            ...
            <section className="border-b-4 border-black relative overflow-hidden">
                ...
                <div className="relative z-10 py-24 px-4 md:px-8 text-white">
                    <div className="max-w-7xl mx-auto">
                        <span className="text-[#ff1a1a] font-bold uppercase tracking-widest text-sm">About Us</span>
                        <h1 className="font-display text-6xl md:text-[10vw] uppercase leading-[0.85] mt-4">
                            We Are <br /><span className="text-[#ff1a1a]">VisualSync</span>
                        </h1>
                        <div className="mt-10 max-w-3xl">
                            <p className="text-[#ff1a1a] font-bold uppercase tracking-widest text-sm"> Our Promise</p>
            ...
            {/* Stats Bar */}
            <section className="border-b-4 border-black bg-[#ff1a1a] text-white">
            ...
            <section className="py-20 px-4 md:px-8 border-b-4 border-black relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16">
                    <div>
                        <span className="text-[#ff1a1a] font-bold uppercase tracking-widest text-sm">Who We Are</span>
            ...
            <section className="py-20 px-4 md:px-8 border-b-4 border-black relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto">
                    <div className="text-center mb-16">
                        <span className="text-[#ff1a1a] font-bold uppercase tracking-widest text-sm">What We Do</span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {services.map((service, i) => (
                            <div
                                key={i}
                                className={`relative border-4 border-black p-8 bg-white overflow-hidden group cursor-pointer transition-all duration-300 hover:shadow-xl ${service.specialty ? 'md:col-span-2 lg:col-span-1' : ''}`}
                            >
                                {/* Hover background */}
                                <div
                                ...
                                <div className="relative z-10">
                                    {service.specialty && (
                                        <span className="inline-block bg-[#ff1a1a] text-white text-xs font-bold uppercase tracking-widest px-3 py-1 mb-4">
                                            Specialty
                                        </span>
                                    )}
                                    <service.icon className="w-10 h-10 mb-4 group-hover:text-[#ff1a1a] transition-colors" />
            ...
            <section className="py-24 px-4 md:px-8 text-white relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-4xl mx-auto text-center">
                    <h2 className="font-display text-5xl md:text-7xl uppercase leading-none">
                        Let's Build <span className="text-[#ff1a1a]">Together</span>
                    </h2>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center mt-10">
                        <a href="/contact" className="bg-[#ff1a1a] text-white px-10 py-4 font-bold uppercase tracking-widest hover:bg-white hover:text-[#ff1a1a] transition-colors inline-flex items-center justify-center gap-3">
                            Get in Touch
                            <ArrowRight size={20} />
                        </a>
                    </div>
